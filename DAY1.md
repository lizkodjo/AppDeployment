...
`Cloud Service Types` are services that cloud providers offer.  Some of the services offered are IaaS (Infastructure as a Service), PaaS (Platform as a Service), SaaS (Software as a Service), FaaS (Function as a Service), etc.
